...
/*
  ...
  BLEByteCharacteristic servo_turn_head_characteristic("47479496-50d5-4072-ab21-f09bfd5a317c", BLERead | BLEWrite);
  BLEDescriptor servo_turn_head_descriptor("38c0622e-db0e-44d1-abed-aec424b66a70", "Turn Head Servo");
  void onServoHeadTurnChange(BLEDevice, BLECharacteristic);
  BLEByteCharacteristic servo_tilt_head_characteristic("23ef21b2-77b6-4325-9a38-f109000bb31a", BLERead | BLEWrite);
  BLEDescriptor servo_tilt_head_descriptor("44b6a4db-5cdf-4bef-b296-4374861a6a8c", "Tilt Head Servo");
  void onServoHeadTiltChange(BLEDevice, BLECharacteristic);
  BLEByteCharacteristic servo_arm_left_characteristic("75c91dff-f7d0-4e90-ad5b-f1686cd44ada", BLERead | BLEWrite);
  BLEDescriptor servo_arm_left_descriptor("a4d980c2-707e-434d-94f8-74fc67cb24b5", "Arm Left Servo");
  void onServoArmLeftChange(BLEDevice, BLECharacteristic);
  BLEByteCharacteristic servo_hand_left_characteristic("97b6572b-4d4e-4d98-8c33-133a1dc012f9", BLERead | BLEWrite);
  BLEDescriptor servo_hand_left_descriptor("725c25ad-7569-44c2-b3e1-61bf09e72964", "Hand Left Servo");
  void onServoHandLeftChange(BLEDevice, BLECharacteristic);
  BLEByteCharacteristic servo_arm_right_characteristic("98f2ce86-1e87-49ee-8c57-729c1b1f0e82", BLERead | BLEWrite);
  BLEDescriptor servo_arm_right_descriptor("15b4b717-2225-4d82-b336-48630fb51109", "Arm Right Servo");
  void onServoArmRightChange(BLEDevice, BLECharacteristic);
  BLEByteCharacteristic servo_hand_right_characteristic("22287c1d-6dab-49af-bcd8-f640aed701ee", BLERead | BLEWrite);
  BLEDescriptor servo_hand_right_descriptor("8072b002-5ea5-441e-ba0e-46248d86b6b0", "Hand Right Servo");
  void onServoHandRightChange(BLEDevice, BLECharacteristic);
  ...
  void buildServoService() {
    ...
    servo_turn_head_characteristic.setEventHandler(BLEWritten, onServoHeadTurnChange);
    ...
    servo_tilt_head_characteristic.setEventHandler(BLEWritten, onServoHeadTiltChange);
  ...
  BLEByteCharacteristic eye_color_characteristic("79888994-2b3f-400d-b6bf-370bac7afb6f", BLERead | BLEWrite);
  ...
  BLEByteCharacteristic eye_style_characteristic("3e8ebb25-6370-493e-8d22-2bb12f45ad57", BLERead | BLEWrite);
